...
public class CityManagerAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        WeatherBean.ResultBean.RealtimeBean jhRealtime = weatherBeanResult.getRealtime();
        WeatherBean.ResultBean.FutureBean jhTodayBean = weatherBeanResult.getFuture().get(0);
//        获取今日天气情况
